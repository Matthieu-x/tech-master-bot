...
// --- Grupos donde el bot principal está activo ---
// En vez de comparar JIDs (poco confiable por los formatos @lid vs
// @s.whatsapp.net), simplemente registramos cuándo el bot principal
// vio actividad en cada grupo. Si fue reciente, el subbot se calla ahí.
const VENTANA_ACTIVIDAD_GRUPO = 6 * 60 * 60 * 1000 // 6 horas
const gruposConBotPrincipal = new Map() // chatId -> timestamp de última actividad vista
