...
function iniciarAutoUpdate(minutos = 30) {
  console.log(`ꕥ AutoUpdate: polling de respaldo activado (revisa cada ${minutos} min).`)
  setInterval(actualizarSiHayCambios, minutos * 60 * 1000)
}
