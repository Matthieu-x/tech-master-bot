 ...
 * -------------------------------------------------------
 * Único comando "visible" de la categoría reacciones.
 * Muestra la lista de reacciones disponibles.
 *
 * El envío real de los gifs vive en plugins/reaccion.js,
 * que usa un RegExp (no un array) como handler.command,
 * por eso no aparece listado en el menú.
 * -------------------------------------------------------
 */
